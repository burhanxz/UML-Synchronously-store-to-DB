...
public class AddVariableValueActionImpl extends WriteVariableActionImpl implements AddVariableValueAction {
	...
	public InputPin getInsertAt() {
		return (InputPin)eGet(UmlPackage.eINSTANCE.getAddVariableValueAction_InsertAt(), true);
	}
	...
	public void setInsertAt(InputPin newInsertAt) {
		eSet(UmlPackage.eINSTANCE.getAddVariableValueAction_InsertAt(), newInsertAt);
	}
	...
	public boolean isIsReplaceAll() {
		return (Boolean)eGet(UmlPackage.eINSTANCE.getAddVariableValueAction_IsReplaceAll(), true);
	}
	...
	public void setIsReplaceAll(boolean newIsReplaceAll) {
		eSet(UmlPackage.eINSTANCE.getAddVariableValueAction_IsReplaceAll(), newIsReplaceAll);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UmlPackage.ADD_VARIABLE_VALUE_ACTION___REQUIRED_VALUE__DIAGNOSTICCHAIN_MAP:
				return required_value((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case UmlPackage.ADD_VARIABLE_VALUE_ACTION___INSERT_AT_PIN__DIAGNOSTICCHAIN_MAP:

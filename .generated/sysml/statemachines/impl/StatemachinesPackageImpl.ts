...
namespace sysml.statemachines.impl {
     ...
     * @class
     */
    export class StatemachinesPackageImpl extends org.eclipse.emf.ecore.impl.EPackageImpl implements sysml.statemachines.StatemachinesPackage {
        /**
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @generated
        ...
        constructor() {
            super(sysml.statemachines.StatemachinesPackage.eNS_URI, sysml.statemachines.StatemachinesFactory.eINSTANCE);
        }
         ...
         * @return {*}
         */
        public static init() : sysml.statemachines.StatemachinesPackage {
            if(StatemachinesPackageImpl.isInited) return <sysml.statemachines.StatemachinesPackage><any>org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.getEPackage(sysml.statemachines.StatemachinesPackage.eNS_URI);
            let theStatemachinesPackage : StatemachinesPackageImpl = <StatemachinesPackageImpl>((org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.get(sysml.statemachines.StatemachinesPackage.eNS_URI) != null && org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.get(sysml.statemachines.StatemachinesPackage.eNS_URI) instanceof <any>sysml.statemachines.impl.StatemachinesPackageImpl)?org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.get(sysml.statemachines.StatemachinesPackage.eNS_URI):new StatemachinesPackageImpl());
            StatemachinesPackageImpl.isInited = true;
            ...
            org.eclipse.emf.ecore.EPackage.Registry.INSTANCE.put(sysml.statemachines.StatemachinesPackage.eNS_URI, theStatemachinesPackage);
         ...
         * @return {*}
         */
        public getStatemachinesFactory() : sysml.statemachines.StatemachinesFactory {
            return <sysml.statemachines.StatemachinesFactory><any>this.getEFactoryInstance();
        }
        ...
        public createPackageContents() {
            ...
            this.isCreated = true;
            this.dummyEDataType = this.createEDataType(sysml.statemachines.StatemachinesPackage.DUMMY);
        }
        ...
        public initializePackageContents() {
            ...
            this.setName(sysml.statemachines.StatemachinesPackage.eNAME);
            this.setNsPrefix(sysml.statemachines.StatemachinesPackage.eNS_PREFIX);
            this.setNsURI(sysml.statemachines.StatemachinesPackage.eNS_URI);
    ...
    StatemachinesPackageImpl["__class"] = "sysml.statemachines.impl.StatemachinesPackageImpl";
    StatemachinesPackageImpl["__interfaces"] = ["sysml.statemachines.StatemachinesPackage","org.eclipse.emf.ecore.EModelElement","org.eclipse.emf.ecore.ENamedElement","org.eclipse.emf.ecore.EStructuralFeature.Internal.DynamicValueHolder","org.eclipse.emf.ecore.EObject","org.eclipse.emf.ecore.util.BasicExtendedMetaData.EPackageExtendedMetaData.Holder","org.eclipse.emf.common.notify.Notifier","org.eclipse.emf.ecore.InternalEObject","org.eclipse.emf.ecore.EPackage"];

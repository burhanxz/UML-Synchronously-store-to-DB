...
namespace uml {
     ...
     * @class
     */
    export interface Gate extends uml.MessageEnd {
        /**
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * <!-- begin-model-doc -->
         ...
         * @return {boolean}
         */
        actual_gate_matched(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean;
         ...
         * @return {boolean}
         */
        inside_cf_matched(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean;
         ...
         * @return {boolean}
         */
        outside_cf_matched(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean;
         ...
         * @return {boolean}
         */
        formal_gate_distinguishable(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean;
         ...
         * @return {boolean}
         */
        actual_gate_distinguishable(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean;
         ...
         * @return {boolean}
         */
        outside_cf_gate_distinguishable(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean;
         ...
         * @return {boolean}
         */
        inside_cf_gate_distinguishable(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean;
         ...
         * @return {boolean}
         */
        matches(gateToMatch : Gate) : boolean;
         ...
         * @return {*}
         */
        getOperand() : uml.InteractionOperand;
    }
}

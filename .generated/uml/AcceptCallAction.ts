...
namespace uml {
     ...
     * </p>
     * <ul>
     * <li>{@link uml.AcceptCallAction#getReturnInformation}</li>
     * </ul>
     * 
     ...
     * @class
     */
    export interface AcceptCallAction extends uml.AcceptEventAction {
        /**
         ...
         * @generated
         */
        getReturnInformation() : uml.OutputPin;

        /**
         * Sets the value of the '{@link uml.AcceptCallAction#getReturnInformation}' containment reference.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         ...
         * @generated
         */
        setReturnInformation(value : uml.OutputPin);
         ...
         * @return {boolean}
         */
        trigger_call_event(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean;
         ...
         * @return {boolean}
         */
        unmarshall(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean;
    }
}

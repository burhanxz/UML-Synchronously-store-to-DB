...
namespace uml.impl {
     ...
     * </p>
     * <ul>
     * <li>{@link uml.impl.ValueSpecificationActionImpl#getResult}</li>
     * <li>{@link uml.impl.ValueSpecificationActionImpl#getValue}</li>
     * </ul>
     * 
     * @generated
     ...
     * @class
     */
    export class ValueSpecificationActionImpl extends uml.impl.ActionImpl implements uml.ValueSpecificationAction {
        constructor() {
            super();
        }
        ...
        eStaticClass() : org.eclipse.emf.ecore.EClass {
            return uml.UmlPackage.eINSTANCE.getValueSpecificationAction();
        }
        ...
        public getResult() : uml.OutputPin {
            return <uml.OutputPin><any>this.eGet(uml.UmlPackage.eINSTANCE.getValueSpecificationAction_Result(), true);
        }
        ...
        public setResult(newResult : uml.OutputPin) {
            this.eSet(uml.UmlPackage.eINSTANCE.getValueSpecificationAction_Result(), newResult);
        }
        ...
        public getValue$() : uml.ValueSpecification {
            return <uml.ValueSpecification><any>this.eGet(uml.UmlPackage.eINSTANCE.getValueSpecificationAction_Value(), true);
        }
        ...
        public setValue$uml_ValueSpecification(newValue : uml.ValueSpecification) {
            this.eSet(uml.UmlPackage.eINSTANCE.getValueSpecificationAction_Value(), newValue);
        }
        ...
        public multiplicity(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean {
            if(false) {
                if(diagnostics != null) {
                    diagnostics.add(new org.eclipse.emf.common.util.BasicDiagnostic(org.eclipse.emf.common.util.Diagnostic.ERROR, uml.util.UmlValidator.DIAGNOSTIC_SOURCE, uml.util.UmlValidator.VALUE_SPECIFICATION_ACTION__MULTIPLICITY, org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", ["multiplicity", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(this, context)]), [this]));
                }
                return false;
            }
            return true;
        ...
        public compatible_type(diagnostics : org.eclipse.emf.common.util.DiagnosticChain, context : any) : boolean {
            if(false) {
                if(diagnostics != null) {
                    diagnostics.add(new org.eclipse.emf.common.util.BasicDiagnostic(org.eclipse.emf.common.util.Diagnostic.ERROR, uml.util.UmlValidator.DIAGNOSTIC_SOURCE, uml.util.UmlValidator.VALUE_SPECIFICATION_ACTION__COMPATIBLE_TYPE, org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", ["compatible_type", org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(this, context)]), [this]));
                }
                return false;
            }
            return true;
        ...
        public eInvoke(operationID : number, __arguments : org.eclipse.emf.common.util.EList<any>) : any {
            switch((operationID)) {
            case uml.UmlPackage.VALUE_SPECIFICATION_ACTION___MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
                return this.multiplicity(<any>__arguments.get(0), <any>__arguments.get(1));
            case uml.UmlPackage.VALUE_SPECIFICATION_ACTION___COMPATIBLE_TYPE__DIAGNOSTICCHAIN_MAP:
                return this.compatible_type(<any>__arguments.get(0), <any>__arguments.get(1));
            }
            return super.eInvoke(operationID, __arguments);
        }
    }
    ValueSpecificationActionImpl["__class"] = "uml.impl.ValueSpecificationActionImpl";
    ValueSpecificationActionImpl["__interfaces"] = ["ecore4m.EModelElement","org.eclipse.emf.ecore.EObject","uml.NamedElement","uml.ActivityContent","org.eclipse.emf.common.notify.Notifier","uml.ExecutableNode","uml.RedefinableElement","uml.ValueSpecificationAction","uml.Action","org.eclipse.emf.ecore.EModelElement","uml.Element","org.eclipse.emf.ecore.EStructuralFeature.Internal.DynamicValueHolder","uml.ActivityNode","org.eclipse.emf.ecore.InternalEObject"];
